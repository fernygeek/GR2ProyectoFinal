...
<head>
    ...
    <title>Registrar mascota — PetCare</title>
...
<body>
    ...
    <main class="auth-page">
        <div class="auth-card">
            ...
            <h1 class="auth-title">Registra tu mascota</h1>
            <p class="auth-subtitle">Aún no tienes mascotas registradas. Completa estos datos para poder agendar.</p>
            ...
            <form action="${pageContext.request.contextPath}/citas" method="post" class="auth-form">
                ...
                <div class="field-with-icon">
                    <input type="text" id="especie" name="especie" placeholder="Perro" required>
                </div>
                ...
                <button type="submit" name="accion" value="guardarMascota" class="btn-gradient">Guardar</button>
                <button type="submit" name="accion" value="cancelarRegistroMascota" formnovalidate class="btn-gradient" style="margin-top: 12px; background: var(--color-input-bg); color: var(--color-text);">Cancelar</button>
            </form>
        </div>
    </main>
