...
<head>
    ...
    <title>Cerrar sesión — PetCare</title>
...
<body>
    ...
    <main class="auth-page">
        <div class="auth-card">
            ...
            <p class="auth-subtitle">${mensajeSalir}</p>

            <form action="${pageContext.request.contextPath}/autenticarse" method="post" class="auth-form">
                <button type="submit" name="accion" value="confirmarCerrarSesion" class="btn-gradient">Confirmar</button>
                <button type="submit" name="accion" value="cancelarCerrarSesion" class="btn-gradient" style="margin-top: 12px; background: var(--color-input-bg); color: var(--color-text);">Cancelar</button>
            </form>
        </div>
    </main>
