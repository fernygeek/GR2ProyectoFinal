...
<head>
    ...
    <title>Registrar pago — PetCare</title>
...
<body>
    ...
    <main class="auth-page">
        <div class="auth-card">
            ...
            <h1 class="auth-title">Registrar Pago</h1>
            <p class="auth-subtitle">Ingresa el monto a cobrar</p>

            <form action="${pageContext.request.contextPath}/registrarPago" method="post" class="auth-form">
